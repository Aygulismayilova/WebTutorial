...
@WebServlet(name = "HelloServletKo", value = "/hello2")
public class HelloServletKo extends HttpServlet {
...
//other request types are allowed of course, but those are the main
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("a POST request was sent to /hello2");
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("a GET request was sent to /hello2");
